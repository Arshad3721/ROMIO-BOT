...
auth_channel = environ.get('AUTH_CHANNEL', '-1001907007440')
...
URL = "https://hot-bot-7uzv.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://hot-bot-7uzv.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://hot-bot-7uzv.onrender.com/".format(FQDN)
else:
    URL = "https://hot-bot-7uzv.onrender.com/".format(FQDN)
