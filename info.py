...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howTodownlodfile')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴏᴅɪғɪᴇᴅ ʙʏ 𖣔ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ𝗕𝗮𝗺𝘀𝗶𖣔ꠋꠋꠋꠋꠋꠋꠋ ❣️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001878088100'))
...
URL = "https://developing-lucie-firoz-cdeb1ea7.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://developing-lucie-firoz-cdeb1ea7.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://developing-lucie-firoz-cdeb1ea7.koyeb.app/".format(FQDN)
else:
    URL = "https://developing-lucie-firoz-cdeb1ea7.koyeb.app/".format(FQDN)
